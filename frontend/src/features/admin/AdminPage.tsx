...
export default function AdminPage() {
  return (
    <Box>
      <Typography variant="h5" sx={{ fontWeight: 700, mb: 3 }}>Administration</Typography>
      <Card sx={{ maxWidth: 600 }}>
        <CardContent>
          <Typography variant="subtitle1" sx={{ fontWeight: 600 }} gutterBottom>System Settings</Typography>
          <Divider sx={{ mb: 2 }} />
          <List disablePadding>
